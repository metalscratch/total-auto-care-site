  ...
  return (
    <div className="min-h-screen bg-dark text-light font-sans">
      <header className="text-center py-10 bg-black">
        <img src="https://m0g.8b4.myftpupload.com/wp-content/uploads/2015/10/Design-logofinal.gif" alt="Total Auto Care Group Logo" className="mx-auto w-48 md:w-60 rounded-xl shadow-xl" />
